...
requireApp('/js/views/search.js');
requireApp('/js/views/list.js');
requireApp('/js/utilities/dom.js');
requireApp('/js/utilities/event_listeners.js');
requireApp('/js/utilities/templates.js');
...
requireApp('/test/unit/mock_fixed_header.js');
...
requireApp('/test/unit/mock_mozContacts.js');
requireApp(
        '/test/unit/mock_performance_testing_helper.js');
