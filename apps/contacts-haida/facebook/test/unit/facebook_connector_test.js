...
requireApp('/js/fb/fb_contact_utils.js');
require('/shared/js/fb/fb_reader_utils.js');
requireApp('/js/fb/fb_contact.js');
requireApp('/facebook/js/facebook_connector.js');
requireApp('/facebook/test/unit/mock_fb_graph_data.js');
requireApp('/facebook/test/unit/mock_fb_query.js');
requireApp('/js/import_utils.js');
